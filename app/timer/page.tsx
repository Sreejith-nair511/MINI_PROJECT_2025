    ...
    <div className="p-6 space-y-6">
      ...
      <div className="glass-card p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Focus Time, {user?.name}! 🎯</h1>
            <p className="text-gray-300">Stay focused and productive with Pomodoro technique</p>
          </div>
